...
| 内容 | 参照先 |
|------|--------|
| Xポスト・記事・発信・コンテンツ戦略 | `../cmo/CLAUDE.md` |
| LP・Notion構築・Webアプリ・AIエージェント制作 | `../cpo/CLAUDE.md` |
| スクリプト・MCP・技術基盤・自動化 | `../cto/CLAUDE.md` |
| 請求書・見積書・売上・経費・契約書 | `../財務/CLAUDE.md` |
| 商談・顧客対応・提案書・営業資料 | `../営業/CLAUDE.md` |
| Notionのどのデータを参照すべきか迷ったら | `../context/notion-map.md` |
